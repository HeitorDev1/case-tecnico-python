...
def calculate_termination_benefits(hire_date, resignation_date, salary):
    
    parsed_hire_date = datetime.strptime(hire_date, "%d/%m/%Y")
    parsed_resignation_date = datetime.strptime(resignation_date, "%d/%m/%Y")
